...
#define _card_enable()      	Chip_GPIO_SetPinOutLow(LPC_GPIO,1,10)
#define _card_disable()     	Chip_GPIO_SetPinOutHigh(LPC_GPIO,1,10)
#define _card_power_on()
#define _card_insert()       	Chip_GPIO_ReadPortBit(LPC_GPIO,1,11)
...
uint8_t SPI_Transmit(uint8_t _data_);
#endif
